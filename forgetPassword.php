...
z-index: 2;" ><a href="login_client.php" style="text-decoration: none;
  ...
  <button style="border-bottom-right-radius:110px; border-top-right-radius:110px; background-color: white;
    ...
    left: 20%;
    right: 20%;
    z-index: 2;" ><a href="#contact" style="text-decoration: none;
  ...
  <button  style="background-color: white;
    ...
    margin-top: 10px;"><i class="material-icons" style="top:4.5px; color: #f1f1f1;">pets</i>
    <a href="login_client.php" style="color: black;text-decoration: none;">
    ...
    transition: width 2s;margin-right: 50px;
    margin-top: 10px;"><i class="material-icons" style="top:4.5px; color: #f1f1f1;">pets</i>
    <a href="https://innergeeksolutions.com/ng/home/login" style="color: black;text-decoration: none;">
...
<div  style="display: flex;
  ...
  <form action="action_page.php"  style="color: #72979D;
    width: 100%;">
      <div  style="padding: 16px;text-align: center;/* justify-content: center; */margin: 0 auto;width: 500px;">
        <h3 style="margin-left:0%; margin-bottom: 0%; color: #5a8288;
    font: italic 1.2em &quot;Fira Sans&quot;, serif;
    font-family: 'Coming Soon', cursive;
    font-weight: 100;
    font-size: 60px;
    ...
    /* margin-left: 10%; */
    float: none;
    text-align: center;">Forget Password</h3>
        <p style="font-family:'Coming Soon', cursive ; margin-left: 0%;">Please fill in this form.</p>
        <hr>

        <label for="email"><b>Email</b></label>
        <input type="email" placeholder="Enter Email" name="email" id="email" required="" style="width: 100%;
    padding: 15px;
    margin: 5px 0 22px 0;
    ...
    border-radius: 200px;">
        ...
        <!-- <label for="psw"><b>Enter OTP (one-time password)</b></label>
        <input type="password" placeholder="Enter OTP sent to your email" name="psw" id="psw" required=""> -->

        <hr>
        <div aria-required="false">
          <button style="border-radius: 200px; margin-bottom: 0px; background-color: #5a8288;padding: 16px 20px;
    margin: 8px 0;
    border: none;
    cursor: pointer;
    width: 100%;
...
if(isset($_POST['register'])){
    ...
    $query = "INSERT INTO clients (first_name, last_name, email, phone, gender, password) 
    VALUES ('$first_name', '$last_name', '$email', '$phone', '$gender', '$password')";
